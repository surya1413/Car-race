...
{
   int gameoverpause=0;
  JLabel hs,br,br1,br2,br3,car,ec1,ec2,ec3,ec4,go;
  ...
  {	
	...
	setLayout(null);
	ImageIcon icon=new ImageIcon("pics/homepage.jpg");
	ImageIcon bar=new ImageIcon("pics/bar.jpg");
	ImageIcon lambo=new ImageIcon("pics/car.png");
	ImageIcon e1=new ImageIcon("pics/enemycar1.png");
	ImageIcon e2=new ImageIcon("pics/enemycar2.png");
	ImageIcon e3=new ImageIcon("pics/enemycar3.png");
	ImageIcon e4=new ImageIcon("pics/enemycar4.png");
	br= new JLabel(bar);
	br1=new JLabel(bar);
	br2=new JLabel(bar);
	br3=new JLabel(bar);
